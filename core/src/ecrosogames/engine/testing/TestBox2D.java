...
//				if (circleBody.getFixtureList().contains(fixtureA, true) || circleBody.getFixtureList().contains(fixtureB, true)) {
//					allowJump = false;
//				}
//			}
//
...
//	}
	...
	protected void updateGame() {
		...
		Vector2 groundPos = groundBody.getTransform().getPosition();
		groundPos.y += 0.05f;
		...
		// spawnCircleFixture();
		// }
//		circleBody.setLinearVelocity(new Vector2(0, circleBody.getLinearVelocity().y));
//		checkInput();
	}
...
//			circleBody.applyForceToCenter(new Vector2(-250 * circleBody.getMass(), 0), false);
//		} else if (input.isKeyPressed(Keys.RIGHT)) {
//			circleBody.applyForceToCenter(new Vector2(250 * circleBody.getMass(), 0), false);
//		}
//		if (input.isKeyPressed(Keys.SPACE)) {
//			if (allowJump) circleBody.applyForceToCenter(new Vector2(0, 250 * circleBody.getMass()), false);
//		}
//	}
